...
import { initialValue, validationSchema } from './FormNewActivo.form';
import { useForm } from '@inertiajs/react'

const AddActivoEmpresa = ({ onClose, Tipos, taqempresa }) =>  {
  ...
  return (
    <form 
        ...
        className = " w-[800px] h-full flex flex-col justify-center items-start justify-items-center px-8 pt-2 pb-8 gap-3"
        method = "POST"
      >
...
export default AddActivoEmpresa;
