...
import { initialValue, validationSchema } from './FormEditResponsables.form';
import { useForm } from '@inertiajs/react'

const EditResponsable = ({ onClose, status, Cargos, Responsable }) =>  {
  ...
  const formik = useFormik({
    initialValues:initialValue(Responsable),
