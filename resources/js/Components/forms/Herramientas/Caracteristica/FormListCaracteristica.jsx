...
import FormPanelEditCaracteristica from "./FormEditCaracteristica/FormEditCaracteristica";
        ...
        DefaultPanel ? (
          Caracteristicas ? (
            Caracteristicas.map( (data) => (
              <div key = { data.taqotro } className="px-4 py-2 w-full h-auto border border-black rounded-md text-black flex justify-between items-center gap-3">
                 ...
                 <div className="w-auto flex justify-center items-center gap-3">
                  ...
                  <div onClick = { () =>  Delete(data) } className="w-auto h-auto px-4 py-2 bg-red-500  rounded-md border-black hover:border-white border cursor-pointer hover:bg-yellow-800 text-white font-semibold">
                    Eliminar
                  </div>
                 </div>
              </div>
