...
import { initialValue, validationSchema } from './FormEditTrabajo.form';
import { useForm } from '@inertiajs/react'

const EditWork  = ({ onClose, Responsables, Trabajo }) =>  { 
  const { data, post } = useForm()
  
  const formik = useFormik({
    initialValues:initialValue(Trabajo),
    validationSchema: validationSchema(),
    validateOnChange: false,
    onSubmit: async (formValue) => {
      data.taqtrabajo      = Trabajo.taqtrabajo
