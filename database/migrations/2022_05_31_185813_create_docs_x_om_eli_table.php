...
class CreateDocsXOmEliTable extends Migration
{
    public function up()
    {
        Schema::create('docs_x_om_eli', function (Blueprint $table) {
        ...
        Schema::table('docs_x_om_eli', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('docs_x_om_eli');
    }
}
