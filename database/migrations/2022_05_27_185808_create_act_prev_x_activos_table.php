...
class CreateActPrevXActivosTable extends Migration
{
    
    public function up()
    {
        Schema::create('act_prev_x_activos', function (Blueprint $table) {
        ...
        Schema::table('act_prev_x_activos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('act_prev_x_activos');
    }
}
